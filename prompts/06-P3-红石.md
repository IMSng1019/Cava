...
- 占用者：
  ...
  - **Lithium**：RedstoneWireBlock.getReceivedRedstonePower（Yarn 名；等于 Mojang calculateTargetStrength，method_27842）上 @Inject(HEAD, cancellable)，整段替换电力计算
  > **勘误（2026-09-22 实读安装 jar）**：**没有 priority=990，用默认 1000**。原句里的 990 是错的。
